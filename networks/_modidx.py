...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'networks.abgabe03': { 'networks.abgabe03.calculate_condition_numbers': ( 'abgabe_blatt_3_kalchschmid_wenzler.html#calculate_condition_numbers',
            ...
            'networks.netana_06': { 'networks.netana_06.draw_trees': ( 'network_analysis_lecture_06.html#draw_trees',
                                                                       'networks/netana_06.py'),
                                    'networks.netana_06.generate_random_tree': ( 'network_analysis_lecture_06.html#generate_random_tree',
                                                                                 'networks/netana_06.py'),
                                    'networks.netana_06.giant_component_size': ( 'network_analysis_lecture_06.html#giant_component_size',
                                                                                 'networks/netana_06.py'),
                                    'networks.netana_06.update_graph': ( 'network_analysis_lecture_06.html#update_graph',
                                                                         'networks/netana_06.py')},
